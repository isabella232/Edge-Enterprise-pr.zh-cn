...
ms.locfileid: "11340582"
---
# <span data-ttu-id="aec73-103">Microsoft Edge WebView2 - 策略</span><span class="sxs-lookup"><span data-stu-id="aec73-103">Microsoft Edge WebView2 - Policies</span></span>
...
## <span data-ttu-id="aec73-108">可用策略</span><span class="sxs-lookup"><span data-stu-id="aec73-108">Available policies</span></span>
...
### [*<span data-ttu-id="aec73-112">加载器替代设置</span><span class="sxs-lookup"><span data-stu-id="aec73-112">Loader Override Settings</span></span>*](#loader-override-settings-policies)
...
|[<span data-ttu-id="aec73-117">ReleaseChannelPreference</span><span class="sxs-lookup"><span data-stu-id="aec73-117">ReleaseChannelPreference</span></span>](#releasechannelpreference)|<span data-ttu-id="aec73-118">设置发布渠道搜索顺序首选项</span><span class="sxs-lookup"><span data-stu-id="aec73-118">Set the release channel search order preference</span></span>|
  ...
  ## <span data-ttu-id="aec73-119">加载器替代设置策略</span><span class="sxs-lookup"><span data-stu-id="aec73-119">Loader Override Settings policies</span></span>
  ...
  ### <span data-ttu-id="aec73-121">BrowserExecutableFolder</span><span class="sxs-lookup"><span data-stu-id="aec73-121">BrowserExecutableFolder</span></span>

  #### <span data-ttu-id="aec73-122">配置浏览器可执行文件文件夹的位置</span><span class="sxs-lookup"><span data-stu-id="aec73-122">Configure the location of the browser executable folder</span></span>

  
  
  #### <span data-ttu-id="aec73-123">支持的版本：</span><span class="sxs-lookup"><span data-stu-id="aec73-123">Supported versions:</span></span>
  ...
  #### <span data-ttu-id="aec73-125">描述</span><span class="sxs-lookup"><span data-stu-id="aec73-125">Description</span></span>
...
<span data-ttu-id="aec73-128">若要设置文件夹路径的值，请提供值名称和值对。</span><span class="sxs-lookup"><span data-stu-id="aec73-128">To set the value for the folder path, provide a Value name and Value pair.</span></span> <span data-ttu-id="aec73-129">将值名称设置为 应用程序用户模型 ID 或可执行文件名称。</span><span class="sxs-lookup"><span data-stu-id="aec73-129">Set value name to the Application User Model ID or the executable file name.</span></span> <span data-ttu-id="aec73-130">可将通配符“\*”用作值名称，以便应用于所有应用程序。</span><span class="sxs-lookup"><span data-stu-id="aec73-130">You can use the "\*" wildcard as value name to apply to all applications.</span></span>
  ...
  #### <span data-ttu-id="aec73-131">支持的功能：</span><span class="sxs-lookup"><span data-stu-id="aec73-131">Supported features:</span></span>
  ...
  #### <span data-ttu-id="aec73-135">数据类型：</span><span class="sxs-lookup"><span data-stu-id="aec73-135">Data Type:</span></span>

  - <span data-ttu-id="aec73-136">字符串列表</span><span class="sxs-lookup"><span data-stu-id="aec73-136">List of strings</span></span>

  #### <span data-ttu-id="aec73-137">Windows 信息和设置</span><span class="sxs-lookup"><span data-stu-id="aec73-137">Windows information and settings</span></span>

  ##### <span data-ttu-id="aec73-138">组策略 (ADMX) 信息</span><span class="sxs-lookup"><span data-stu-id="aec73-138">Group Policy (ADMX) info</span></span>
  ...
  ##### <span data-ttu-id="aec73-144">Windows 注册表设置</span><span class="sxs-lookup"><span data-stu-id="aec73-144">Windows Registry Settings</span></span>
  ...
  ##### <span data-ttu-id="aec73-149">示例值：</span><span class="sxs-lookup"><span data-stu-id="aec73-149">Example value:</span></span>
...
```
  ...
  ### <span data-ttu-id="aec73-151">ReleaseChannelPreference</span><span class="sxs-lookup"><span data-stu-id="aec73-151">ReleaseChannelPreference</span></span>

  #### <span data-ttu-id="aec73-152">设置发布渠道搜索顺序首选项</span><span class="sxs-lookup"><span data-stu-id="aec73-152">Set the release channel search order preference</span></span>

  
  
  #### <span data-ttu-id="aec73-153">支持的版本：</span><span class="sxs-lookup"><span data-stu-id="aec73-153">Supported versions:</span></span>
  ...
  #### <span data-ttu-id="aec73-155">描述</span><span class="sxs-lookup"><span data-stu-id="aec73-155">Description</span></span>
...
<span data-ttu-id="aec73-158">若要设置发布渠道首选项的值，请提供值名称和值对。</span><span class="sxs-lookup"><span data-stu-id="aec73-158">To set the value for the release channel preference, provide a Value name and Value pair.</span></span> <span data-ttu-id="aec73-159">将值名称设置为 应用程序用户模型 ID 或可执行文件名称。</span><span class="sxs-lookup"><span data-stu-id="aec73-159">Set value name to the Application User Model ID or the executable file name.</span></span> <span data-ttu-id="aec73-160">可将通配符“\*”用作值名称，以便应用于所有应用程序。</span><span class="sxs-lookup"><span data-stu-id="aec73-160">You can use the "\*" wildcard as value name to apply to all applications.</span></span>
  ...
  #### <span data-ttu-id="aec73-161">支持的功能：</span><span class="sxs-lookup"><span data-stu-id="aec73-161">Supported features:</span></span>
  ...
  #### <span data-ttu-id="aec73-165">数据类型：</span><span class="sxs-lookup"><span data-stu-id="aec73-165">Data Type:</span></span>

  - <span data-ttu-id="aec73-166">字符串列表</span><span class="sxs-lookup"><span data-stu-id="aec73-166">List of strings</span></span>

  #### <span data-ttu-id="aec73-167">Windows 信息和设置</span><span class="sxs-lookup"><span data-stu-id="aec73-167">Windows information and settings</span></span>

  ##### <span data-ttu-id="aec73-168">组策略 (ADMX) 信息</span><span class="sxs-lookup"><span data-stu-id="aec73-168">Group Policy (ADMX) info</span></span>
  ...
  ##### <span data-ttu-id="aec73-174">Windows 注册表设置</span><span class="sxs-lookup"><span data-stu-id="aec73-174">Windows Registry Settings</span></span>
  ...
  ##### <span data-ttu-id="aec73-179">示例值：</span><span class="sxs-lookup"><span data-stu-id="aec73-179">Example value:</span></span>
...
## <span data-ttu-id="aec73-181">另请参阅</span><span class="sxs-lookup"><span data-stu-id="aec73-181">See also</span></span>
