...
```
  ...
  #### <a name="allow-personalization-of-ads-search-and-news-by-sending-browsing-history-to-microsoft"></a>通过向 Microsoft 发送浏览历史记录，允许对广告、搜索和新闻进行个性化设置
...
```
  ...
  #### <a name="allow-freezing-of-background-tabs"></a>允许冻结后台选项卡
