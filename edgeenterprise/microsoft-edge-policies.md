...
- [性能](#performance)
- [允许或拒绝屏幕捕获](#permit-or-deny-screen-capture)
- [打印](#printing)
...
|[DefaultWebHidGuardSetting](#defaultwebhidguardsetting)|控制 WebUSB API 的使用|
...
|[IntranetFileLinksEnabled](#intranetfilelinksenabled)|允许在 Windows 文件资源管理器中打开来自 Microsoft Edge 的 Intranet 区域文件 URL 链接|
...
|[LegacySameSiteCookieBehaviorEnabled](#legacysamesitecookiebehaviorenabled)|启用默认的旧 SameSite Cookie 行为设置（已过时）|
...
|[SerialAllowAllPortsForUrls](#serialallowallportsforurls)|自动授予站点权限连接所有串行端口|
|[SerialAllowUsbDevicesForUrls](#serialallowusbdevicesforurls)|自动授予站点权限连接到 USB 串行设备|
...
|[WebHidAskForUrls](#webhidaskforurls)|在这些站点上允许 WebHID API|
|[WebHidBlockedForUrls](#webhidblockedforurls)|在这些站点上阻止 WebHID API|
...
|[ControlDefaultStateOfAllowExtensionFromOtherStoresSettingEnabled](#controldefaultstateofallowextensionfromotherstoressettingenabled)|配置“允许来自其他商店的扩展”设置的默认状态|
...
|策略名称|描述文字|
|-|-|
|[EdgeDefaultProfileEnabled](#edgedefaultprofileenabled)|已启用默认配置文件设置|
...
|[SignInCtaOnNtpEnabled](#signinctaonntpenabled)|启用登录单击操作对话框|
...
|[KioskSwipeGesturesEnabled](#kioskswipegesturesenabled)|已启用 Microsoft Edge 展台模式下的轻扫手势|
...
|[PasswordManagerBlocklist](#passwordmanagerblocklist)|配置将禁用密码管理器 UI (保存和填充) 的域列表|
...
|[PasswordRevealEnabled](#passwordrevealenabled)|启用“密码”显示按钮|
...
### [*<a name="permit-or-deny-screen-capture"></a>允许或拒绝屏幕捕获*](#permit-or-deny-screen-capture-policies)

|策略名称|字幕|
|-|-|
|[SameOriginTabCaptureAllowedByOrigins](#sameorigintabcaptureallowedbyorigins)|允许这些源捕获同一源选项卡|
|[ScreenCaptureAllowedByOrigins](#screencaptureallowedbyorigins)|允许按这些源捕获桌面、窗口和选项卡|
|[TabCaptureAllowedByOrigins](#tabcaptureallowedbyorigins)|允许按这些源捕获选项卡|
|[WindowCaptureAllowedByOrigins](#windowcaptureallowedbyorigins)|允许按这些源捕获窗口和选项卡|
...
|[PrintPostScriptMode](#printpostscriptmode)|打印 PostScript 模式|
...
|[PrintRasterizePdfDpi](#printrasterizepdfdpi)|打印光栅化 PDF DPI|
|[PrintStickySettings](#printstickysettings)|打印预览粘滞设置|
...
|[SmartScreenDnsRequestsEnabled](#smartscreendnsrequestsenabled)|启用 Microsoft Defender SmartScreen DNS 请求|
...
|[AccessibilityImageLabelsEnabled](#accessibilityimagelabelsenabled)|允许屏幕阅读器用户从 Microsoft 获取图像说明|
|[AddressBarEditingEnabled](#addressbareditingenabled)|配置地址栏编辑|
...
|[AdsTransparencyEnabled](#adstransparencyenabled)|配置是否启用广告透明度功能|
...
|[AllowGamesMenu](#allowgamesmenu)|允许用户访问游戏菜单|
|[AllowPopupsDuringPageUnload](#allowpopupsduringpageunload)|允许页面在卸载期间显示弹出窗口（过时）|
|[AllowSurfGame](#allowsurfgame)|允许冲浪游戏|
|[AllowSyncXHRInPageDismissal](#allowsyncxhrinpagedismissal)|允许页面在页面关闭期间发送同步 XHR 请求(已过时)|
...
|[AppCacheForceEnabled](#appcacheforceenabled)|允许重新启用 AppCache 功能，即使因默认方式于关闭状态(已过时)|
...
|[AutofillCreditCardEnabled](#autofillcreditcardenabled)|启用付款方式自动填充|
...
|[BackgroundTemplateListUpdatesEnabled](#backgroundtemplatelistupdatesenabled)|对“集锦”和使用模板的其他功能启用可用模板列表后台更新(已弃用)|
...
|[BrowserLegacyExtensionPointsBlockingEnabled](#browserlegacyextensionpointsblockingenabled)|启用浏览器旧扩展点阻止|
...
|[CORSNonWildcardRequestHeadersSupport](#corsnonwildcardrequestheaderssupport)|已启用 CORS 非通配符请求标头支持 (已弃用)|
...
|[ConfigureKeyboardShortcuts](#configurekeyboardshortcuts)|配置要为其禁用键盘快捷方式的命令列表|
...
|[ConfigureViewInFileExplorer](#configureviewinfileexplorer)|在 Microsoft Edge 中为 SharePoint 页面配置在文件资源管理器中查看功能|
|[CrossOriginWebAssemblyModuleSharingEnabled](#crossoriginwebassemblymodulesharingenabled)|指定是否可以跨源发送 WebAssembly 模块（已过时）|
...
|[DisplayCapturePermissionsPolicyEnabled](#displaycapturepermissionspolicyenabled)|指定是选中还是跳过显示捕获权限策略|
...
|[DoNotSilentlyBlockProtocolsFromOrigins](#donotsilentlyblockprotocolsfromorigins)|定义防淹没防护无法静默阻止的协议列表|
|[DownloadDirectory](#downloaddirectory)|设置下载目录|
|[DownloadRestrictions](#downloadrestrictions)|允许下载限制|
|[EdgeAssetDeliveryServiceEnabled](#edgeassetdeliveryserviceenabled)|允许功能从资产传递服务下载资产|
|[EdgeCollectionsEnabled](#edgecollectionsenabled)|启用“集锦”功能|
|[EdgeDiscoverEnabled](#edgediscoverenabled)|发现 Microsoft Edge 中的功能|
|[EdgeEnhanceImagesEnabled](#edgeenhanceimagesenabled)|已启用增强图像|
|[EdgeFollowEnabled](#edgefollowenabled)|在 Microsoft Edge 中启用关注服务|
...
|[EnhanceSecurityMode](#enhancesecuritymode)|增强 Microsoft Edge 中的安全状态|
|[EnhanceSecurityModeBypassListDomains](#enhancesecuritymodebypasslistdomains)|配置将不会强制执行增强安全模式的域列表|
|[EnhanceSecurityModeEnforceListDomains](#enhancesecuritymodeenforcelistdomains)|配置将始终强制执行增强安全模式的域列表|
...
|[ForceCertificatePromptsOnMultipleMatches](#forcecertificatepromptsonmultiplematches)|当使用“AutoSelectCertificateForUrls”配置的网站具有多个证书匹配项时，配置 Microsoft Edge 是否应自动选择证书（已弃用）|
...
|[ForceMajorVersionToMinorPositionInUserAgent](#forcemajorversiontominorpositioninuseragent)|启用或禁用将用户代理字符串冻结在主版本 99|
...
|[HideRestoreDialogEnabled](#hiderestoredialogenabled)|在浏览器崩溃后隐藏“还原页面”对话框|
|[HubsSidebarEnabled](#hubssidebarenabled)|显示中心边栏|
...
|[InAppSupportEnabled](#inappsupportenabled)|已启用应用内支持|
...
|[InternetExplorerIntegrationCloudNeutralSitesReporting](#internetexplorerintegrationcloudneutralsitesreporting)|配置向 M365 管理中心网站列表应用报告可能配置错误的中性网站 URL|
|[InternetExplorerIntegrationCloudSiteList](#internetexplorerintegrationcloudsitelist)|配置“企业模式云站点列表”|
|[InternetExplorerIntegrationCloudUserSitesReporting](#internetexplorerintegrationcloudusersitesreporting)|配置向 M365 管理中心网站列表应用报告 IE 模式用户列表条目|
...
|[InternetExplorerModeEnableSavePageAs](#internetexplorermodeenablesavepageas)|允许在 Internet Explorer 模式下使用“页面另存为”|
|[InternetExplorerModeTabInEdgeModeAllowed](#internetexplorermodetabinedgemodeallowed)|允许为 Internet Explorer 模式配置的网站在 Microsoft Edge 中打开|
...
|[MicrosoftEdgeInsiderPromotionEnabled](#microsoftedgeinsiderpromotionenabled)|已启用 Microsoft Edge 预览体验成员促销|
|[MicrosoftOfficeMenuEnabled](#microsoftofficemenuenabled)|允许用户访问 Microsoft Office 菜单|
...
|[PromptOnMultipleMatchingCertificates](#promptonmultiplematchingcertificates)|当多个证书匹配时提示用户选择证书|
...
|[RelatedMatchesCloudServiceEnabled](#relatedmatchescloudserviceenabled)|在“在页面查找”中配置相关匹配项|
...
|[RestrictSigninToPattern](#restrictsignintopattern)|限制哪些账户可以用来登录 Microsoft Edge|
...
|[SandboxExternalProtocolBlocked](#sandboxexternalprotocolblocked)|允许 Microsoft Edge 在沙盒 iframe 中阻止对外部协议的导航|
...
|[SiteSafetyServicesEnabled](#sitesafetyservicesenabled)|允许用户配置网站安全服务|
...
|[U2fSecurityKeyApiEnabled](#u2fsecuritykeyapienabled)|允许使用已废弃的 U2F 安全密钥 API (已弃用)|
...
|[UserAgentReduction](#useragentreduction)|启用或禁用用户代理缩减|
...
|[VisualSearchEnabled](#visualsearchenabled)|已启用视觉搜索|
...
|[WebSQLInThirdPartyContextEnabled](#websqlinthirdpartycontextenabled)|强制重新启用第三方上下文中的 WebSQL（已过时）|
...
|[WinHttpProxyResolverEnabled](#winhttpproxyresolverenabled)|使用 Windows 代理解析程序|
...
```
  ...
  ### <a name="defaultwebhidguardsetting"></a>DefaultWebHidGuardSetting

  #### <a name="control-use-of-the-webhid-api"></a>控制 WebUSB API 的使用
...
对于特定的 URL 模式，可以使用 [WebHidAskForUrls](#webhidaskforurls) 和 [WebHidBlockedForUrls](#webhidblockedforurls) 策略覆盖此策略。
...
```
  ...
  #### <a name="allow-intranet-zone-file-url-links-from-microsoft-edge-to-open-in-windows-file-explorer"></a>允许在 Windows 文件资源管理器中打开来自 Microsoft Edge 的 Intranet 区域文件 URL 链接
...
除非禁用了 [ExternalProtocolDialogShowAlwaysOpenCheckbox](#externalprotocoldialogshowalwaysopencheckbox) 策略，否则用户可以按每个协议/每个站点选择退出提示。
...
```
  ...
  #### <a name="allow-javascript-to-use-jit-on-these-sites"></a>允许 JavaScript 在这些站点上使用 JIT
...
有关有效站点 URL 模式的详细信息，请参阅 [https://go.microsoft.com/fwlink/?linkid=2095322](https://go.microsoft.com/fwlink/?linkid=2095322)。 * 非此策略的接受值。
...
此策略逐帧应用，且不仅仅基于顶级源 URL。例如，如果 contoso.com 在 JavaScriptJitAllowedForSites 策略中列出，但加载了包含 fabrikam.com 的帧，则其将启用 JavaScript JIT，但 fabrikam.com 将使用 [DefaultJavaScriptJitSetting](#defaultjavascriptjitsetting) 中的策略(如果已设置)，或默认为已启用 JavaScript JIT。

如果不为站点配置此策略，则 [DefaultJavaScriptJitSetting](#defaultjavascriptjitsetting) 中的策略将应用于站点(如果已设置)，否则会为站点启用 Javascript JIT。
...
```
  ...
  #### <a name="block-javascript-from-using-jit-on-these-sites"></a>阻止 JavaScript 在这些站点上使用 JIT
...
有关有效 url 模式的详细信息，请参阅 [https://go.microsoft.com/fwlink/?linkid=2095322](https://go.microsoft.com/fwlink/?linkid=2095322)。 * 非此策略的接受值。

JavaScript JIT 策略异常将仅在站点粒度上(eTLD+1)强制执行。 仅针对 subdomain.contoso.com 的策略集将无法正确应用于 contoso.com 或 subdomain.contoso.com，因为两者都解析为同一个无策略的 eTLD+1 (contoso.com)。 在这种情况下，必须在 contoso.com 上设置策略以正确应用于 contoso.com 和 subdomain.contoso.com。

此策略逐帧应用，且不仅仅基于顶级源 URL。例如，如果 contoso.com 在 JavaScriptJittBlockedForSites 策略中列出，但加载了包含 fabrikam.com 的帧，则其将禁用 JavaScript JIT，但 fabrikam.com 将使用 [DefaultJavaScriptJitSetting](#defaultjavascriptjitsetting) 中的策略(如果已设置)，或默认为已启用 JavaScript JIT。

如果未为站点配置此策略，则 [DefaultJavaScriptJitSetting](#defaultjavascriptjitsetting) 中的策略将应用于站点(如果已设置)，否则会为站点启用 JavaScript JIT。
...
```
  ...
  #### <a name="enable-default-legacy-samesite-cookie-behavior-setting-obsolete"></a>启用默认的旧 SameSite Cookie 行为设置（已过时）
...
如果仍需要旧 Cookie 行为，请使用 [LegacySameSiteCookieBehaviorEnabledForDomainList](#legacysamesitecookiebehaviorenabledfordomainlist) 来对每个域分别配置行为。
...
```
  ...
  #### <a name="automatically-grant-sites-permission-to-connect-all-serial-ports"></a>自动授予站点权限连接所有串行端口
...
此策略将替代 [DefaultSerialGuardSetting](#defaultserialguardsetting)、[SerialAskForUrls](#serialaskforurls)、[SerialBlockedForUrls](#serialblockedforurls) 和用户首选项。
...
```
  ...
  #### <a name="automatically-grant-sites-permission-to-connect-to-usb-serial-devices"></a>自动授予站点权限连接到 USB 串行设备
...
此策略仅影响通过 Web 串行 API 访问 USB 设备。 若要通过 WebUSB API 授予对 USB 设备的访问权限，请参阅 [WebUsbAllowDevicesForUrls](#webusballowdevicesforurls) 策略。
...
```
  ...
  #### <a name="allow-notifications-to-set-microsoft-edge-as-default-pdf-reader"></a>允许通知将 Microsoft Edge 设置为默认 PDF 阅读器
...
```
  ...
  ### <a name="webhidaskforurls"></a>WebHidAskForUrls

  #### <a name="allow-the-webhid-api-on-these-sites"></a>在这些站点上允许 WebHID API
...
如果策略未设置，则表示 [DefaultWebHidGuardSetting](#defaultwebhidguardsetting) 适用于所有站点（如果已设置）。 如果未设置该策略，则应用用户的个人设置。

对于与策略不匹配的 URL 模式，按优先顺序应用以下值：

  * [WebHidBlockedForUrls](#webhidblockedforurls)（如果有匹配项），

  * [DefaultWebHidGuardSetting](#defaultwebhidguardsetting) （如果已设置），或

  * 用户的个人设置。

URL 模式不得与 [WebHidBlockedForUrls](#webhidblockedforurls) 冲突。 如果 URL 与这两种模式匹配，则两个策略都不具有优先权。
...
```
  ...
  ### <a name="webhidblockedforurls"></a>WebHidBlockedForUrls

  #### <a name="block-the-webhid-api-on-these-sites"></a>在这些站点上阻止 WebHID API
...
对于与策略不匹配的 URL 模式，按优先顺序应用以下值：
  ...
  * [WebHidAskForUrls](#webhidaskforurls)（如果有匹配项），

  * [DefaultWebHidGuardSetting](#defaultwebhidguardsetting) （如果已设置），或

  * 用户的个人设置。

URL 模式不得与 [WebHidAskForUrls](#webhidaskforurls) 冲突。 如果 URL 与这两种模式匹配，则两个策略都不具有优先权。
...
```
  ...
  ## <a name="experimentation-policies"></a>实验策略

  [返回顶部](#microsoft-edge---policies)

  ### <a name="featureflagoverridescontrol"></a>FeatureFlagOverridesControl

  #### <a name="configure-users-ability-to-override-feature-flags"></a>配置用户替代功能标志的能力
  ...
  配置用户替代功能标志状态的能力。
如果此策略设置为 'CommandLineOverridesEnabled'，则用户可以使用命令行参数而非 edge://flags 页面以替代功能标志的状态。
...
```
  ...
  ### <a name="controldefaultstateofallowextensionfromotherstoressettingenabled"></a>ControlDefaultStateOfAllowExtensionFromOtherStoresSettingEnabled

  #### <a name="configure-default-state-of-allow-extensions-from-other-stores-setting"></a>配置“允许来自其他商店的扩展”设置的默认状态
  ...
  使用此策略，可以控制其他存储设置中的"允许扩展"的默认状态。
此策略不能用于停止从其他存储（如Chrome Web Store）安装扩展。
如果要停止从其他存储安装扩展，请使用扩展设置策略： [https://go.microsoft.com/fwlink/?linkid=2187098](https://go.microsoft.com/fwlink/?linkid=2187098)。

启用后，将启用来自其他商店的允许扩展。 因此，用户无需在安装其他受支持商店（如 Chrome Web Store）中的扩展时手动打开标志。 但是，用户可以替代此设置。
如果用户已打开该设置，然后将其关闭，则此设置可能不起作用。
如果管理员首先将策略设置为"已启用"，然后将其更改为"未配置"或"已禁用"，则不会影响用户设置，并且设置将保持不变。
...
此策略取代了 [ExtensionInstallBlocklist](#extensioninstallblocklist) 策略。 如果之前强制安装的应用或扩展已从此列表中删除，则 Microsoft Edge 会进行自动卸载。
...
此策略仅将扩展 ID 或更新 URL 映射到其特定设置。 可以针对特殊 ID"*"设置默认配置，此配置适用于在此策略中无自定义配置的所有扩展。 借助更新 URL，配置应用于扩展清单中所述的具有精确更新 URL 的扩展。 如果 'override_update_url' 标志设置为 true，则系统会使用此策略中 [ExtensionInstallForcelist](#extensioninstallforcelist) 策略或 'update_url' 字段中指定的更新 URL 以安装并更新扩展。 如果 'update_url' 为 Edge 外接程序网站更新 URL，则系统会忽略 'override_update_url' 标志。 更多详细信息，请查看 [https://go.microsoft.com/fwlink/?linkid=2161555](https://go.microsoft.com/fwlink/?linkid=2161555) 上提供的 ExtensionSettings 策略详细指南。
...
```
  ...
  #### <a name="list-of-origins-that-allow-all-http-authentication"></a>允许所有 HTTP 身份验证的源列表
  ...
  设置此策略以指定哪些源允许使用 Microsoft Edge 支持的所有 HTTP 身份验证方案，而不考虑 [AuthSchemes](#authschemes) 策略。

根据此格式设置源模式的格式（https://www.chromium.org/administrators/url-blocklist-filter-format)。 最多可在 [AllHttpAuthSchemesAllowedForOrigins](#allhttpauthschemesallowedfororigins) 中定义 1,000 个异常。
允许对整个源或源的部件使用通配符。 部件包括方案、主机或端口。
...
```
  ...
  ## <a name="identity-and-sign-in-policies"></a>身份和登录策略

  [返回顶部](#microsoft-edge---policies)

  ### <a name="edgedefaultprofileenabled"></a>EdgeDefaultProfileEnabled

  #### <a name="default-profile-setting-enabled"></a>已启用默认配置文件设置
  ...
  通过配置此策略后，可以在 Microsoft Edge 中设置一个在打开浏览器时使用的默认配置文件（而不是使用上一个配置文件）。 在已指定“--profile-directory”参数时，此策略不会产生影响。 将值设置为“默认”可引用默认配置文件。 值区分大小写。
策略的值是配置文件的名称（区分大小写），并且可以使用作为特定配置文件名称的字符串进行配置。
值“Edge 儿童模式”和“来宾配置文件”被认为是无用值，因为它们不应是默认配置文件。
此策略将不会影响以下方案：
  1) 在“配置文件首选项”的“网站配置文件首选项”中指定的设置
  2) 从 Outlook 和 Teams 打开的链接。

以下语句处于未指定“--profile-directory”的条件下，并且配置的值不是“Edge 儿童模式”或“来宾配置文件”：如果启用此策略并使用特定配置文件名称对其进行配置，并且可以找到指定的配置文件，则 Microsoft Edge 将在启动时使用指定的配置文件，并且“外部链接的默认配置文件”设置将更改为指定的配置文件名称并灰显。如果启用此策略并使用特定配置文件名称对其进行配置，但找不到该策略，则该策略的行为将表现为以前从未设置过。
如果启用此策略，但未配置或禁用此策略，则该策略的行为将类似于以前从未设置过。
...
```
  ...
  #### <a name="enable-implicit-sign-in"></a>启用隐式登录
...
如果已将 [BrowserSignin](#browsersignin) 策略配置为‘禁用浏览器登录’，则此策略将不会生效。
...
```
  ...
  #### <a name="oneauth-authentication-flow-enforced-for-signin"></a>登录的强制执行的 OneAuth 身份验证流
...
如果禁用或不配置此策略，则登录流程将使用 Windows帐户管理器。 Microsoft Edge 无需密码即可使用登录到 Windows、Microsoft Office 或其他 Microsoft 应用程序的帐户进行登录。 或者，你可以提供有效的帐户和密码以进行登录，这些信息将存储在 Windows 帐户管理器中以供未来使用。 你将能够通过“Windows 设置” -> “帐户” -> “电子邮件和帐户页面”调查所有存储在 Windows 帐户管理器中的帐户。
...
```
  ...
  #### <a name="only-on-premises-account-enabled-for-implicit-sign-in"></a>只为隐式登录启用本地帐户
...
此策略将仅在策略 [ConfigureOnPremisesAccountAutoSignIn](#configureonpremisesaccountautosignin) 已启用并设置为 'SignInAndMakeDomainAccountNonRemovable' 时才生效。
...
```
  ...
  ### <a name="signinctaonntpenabled"></a>SignInCtaOnNtpEnabled

  #### <a name="enable-sign-in-click-to-action-dialog"></a>启用登录单击操作对话框
...
```
  ...
  #### <a name="wam-for-authentication-below-windows-10-rs3-enabled"></a>已启用低于 Windows 10 RS3 的版本中用于身份验证的 WAM
...
```
  ...
  #### <a name="swipe-gestures-in-microsoft-edge-kiosk-mode-enabled"></a>已启用 Microsoft Edge 展台模式下的轻扫手势
...
```
  ...
  #### <a name="allow-users-to-get-a-strong-password-suggestion-whenever-they-are-creating-an-account-online"></a>允许用户在每次联机创建帐户时获取强密码建议
...
```
  ...
  ### <a name="passwordmanagerblocklist"></a>PasswordManagerBlocklist

  #### <a name="configure-the-list-of-domains-for-which-the-password-manager-ui-save-and-fill-will-be-disabled"></a>配置将禁用密码管理器 UI (保存和填充) 的域列表
...
```
  ...
  #### <a name="configures-a-setting-that-asks-users-to-enter-their-device-password-while-using-password-autofill"></a>配置要求用户在使用密码自动填充时输入设备密码的设置
...
如果将此策略设置为‘使用设备密码’，则用户需要输入其设备密码(或 Windows Hello 下的首选身份验证模式(如果位于 Windows 上) - PIN、面部识别或指纹以及 Mac 上的等效选项)以证明其身份，只有这样其密码才会自动填充。 此外，默认情况下，身份验证提示的频率会设置为‘始终’，但用户也可以将其更改为其他选项，即‘每个浏览会话一次’。
...
```
  ...
  ## <a name="permit-or-deny-screen-capture-policies"></a>允许或拒绝屏幕捕获策略

  [返回页首](#microsoft-edge---policies)

  ### <a name="sameorigintabcaptureallowedbyorigins"></a>SameOriginTabCaptureAllowedByOrigins

  #### <a name="allow-same-origin-tab-capture-by-these-origins"></a>允许这些源捕获同一源选项卡
...
如果网站与此策略中的 URL 模式匹配，则不会考虑以下策略: [TabCaptureAllowedByOrigins](#tabcaptureallowedbyorigins)、[WindowCaptureAllowedByOrigins](#windowcaptureallowedbyorigins)、[ScreenCaptureAllowedByOrigins](#screencaptureallowedbyorigins)、[ScreenCaptureAllowed](#screencaptureallowed)。

有关有效 url 模式的详细信息，请参阅 [https://go.microsoft.com/fwlink/?linkid=2095322](https://go.microsoft.com/fwlink/?linkid=2095322)。  此策略仅基于源匹配，因此会忽略 URL 模式的任何路径。
...
```
  ...
  #### <a name="allow-desktop-window-and-tab-capture-by-these-origins"></a>允许按这些源捕获桌面、窗口和选项卡
...
如果网站与以下任何策略中的 URL 模式匹配，则不考虑此策略: [WindowCaptureAllowedByOrigins](#windowcaptureallowedbyorigins)、[TabCaptureAllowedByOrigins](#tabcaptureallowedbyorigins)、[SameOriginTabCaptureAllowedByOrigins](#sameorigintabcaptureallowedbyorigins)。

如果站点与此策略中的 URL 模式匹配，则不会考虑 [ScreenCaptureAllowed](#screencaptureallowed)。
...
```
  ...
  #### <a name="allow-tab-capture-by-these-origins"></a>允许按这些源捕获选项卡
...
如果站点与 [SameOriginTabCaptureAllowedByOrigins](#sameorigintabcaptureallowedbyorigins) 策略中的 URL 模式匹配，则不考虑此策略。

如果网站与此策略中的 URL 模式匹配，则不会考虑以下策略: [WindowCaptureAllowedByOrigins](#windowcaptureallowedbyorigins)、[ScreenCaptureAllowedByOrigins](#screencaptureallowedbyorigins)、[ScreenCaptureAllowed](#screencaptureallowed)。
...
```
  ...
  #### <a name="allow-window-and-tab-capture-by-these-origins"></a>允许按这些源捕获窗口和选项卡
...
如果网站与以下任何策略中的 URL 模式匹配，则不考虑此策略: [TabCaptureAllowedByOrigins](#tabcaptureallowedbyorigins)、[SameOriginTabCaptureAllowedByOrigins](#sameorigintabcaptureallowedbyorigins)。

如果网站与此策略中的 URL 模式匹配，则不会考虑以下策略: [ScreenCaptureAllowedByOrigins](#screencaptureallowedbyorigins)、[ScreenCaptureAllowed](#screencaptureallowed)。
...
```
  ...
  #### <a name="print-postscript-mode"></a>打印 PostScript 模式
...
```
  ...
  #### <a name="print-rasterize-pdf-dpi"></a>打印光栅化 PDF DPI
...
```
  ...
  #### <a name="print-preview-sticky-settings"></a>打印预览粘滞设置
...
仅当启用或未配置 [PrintingEnabled](#printingenabled) 策略时，此策略才可用。
...
本地打印机也称为本机打印目标，且包含本地计算机可用的目标和共享网络打印机。
...
```
  ...
  #### <a name="sets-layout-for-printing"></a>设置打印布局
...
如果禁用或不配置此策略，则用户可以决定是以纵向还是横向布局打印网页。

如果启用此策略，则选定选项会设置为布局选项。
...
更多详细示例，请转到 [https://go.microsoft.com/fwlink/?linkid=2094936](https://go.microsoft.com/fwlink/?linkid=2094936)。
...
```
  ...
  #### <a name="enable-microsoft-defender-smartscreen-dns-requests"></a>启用 Microsoft Defender SmartScreen DNS 请求
...
如果启用此策略，则“主页”按钮将设置为用户配置的新选项卡页或使用策略 [NewTabPageLocation](#newtabpagelocation) 进行设置，且不会考虑使用策略 [HomepageLocation](#homepagelocation) 设置的 URL。

如果禁用此策略，则“主页”按钮为用户配置的或策略 [HomepageLocation](#homepagelocation) 中配置的设置 URL。
...
可以在此处设置 URL，或设置主页以打开新选项卡页 'edge://newtab'。 默认情况下，“主页”按钮将打开新选项卡页(由用户配置或使用策略 [NewTabPageLocation](#newtabpagelocation) 配置)，且用户将能够在此策略配置的 URL 和新选项卡页之间进行选择。

如果启用此策略，则用户无法更改其主页 URL，但可以选择“主页”按钮的行为以打开设置 URL 或新选项卡页。 如果要强制使用设置 URL，还必须配置 [HomepageIsNewTabPage](#homepageisnewtabpage)=Disabled。

如果禁用或不配置此策略，则只要未启用 [HomepageIsNewTabPage](#homepageisnewtabpage) 策略，用户便可选择自己的主页。
...
```
  ...
  #### <a name="let-screen-reader-users-get-image-descriptions-from-microsoft"></a>允许屏幕阅读器用户从 Microsoft 获取图像说明
...
```
  ...
  #### <a name="configure-address-bar-editing"></a>配置地址栏编辑
...
- [URLBlocklist](#urlblocklist) 和 [URLAllowlist](#urlallowlist) 以确定浏览器可以浏览的页面范围。
...
```
  ...
  ### <a name="adstransparencyenabled"></a>AdsTransparencyEnabled

  #### <a name="configure-if-the-ads-transparency-feature-is-enabled"></a>配置是否启用广告透明度功能
  ...
  允许你确定是否启用广告透明度功能。 此行为仅适用于跟踪防护的"平衡"模式，不影响"基本"或"严格"模式。 可以使用 [TrackingPrevention](#trackingprevention) 策略配置用户的跟踪防护级别。 AdsTransparencyEnabled 仅在 [TrackingPrevention](#trackingprevention) 设置为 TrackingPreventionBalanced 或未配置时有效。
...
```
  ...
  ### <a name="allowgamesmenu"></a>AllowGamesMenu

  #### <a name="allow-users-to-access-the-games-menu"></a>允许用户访问游戏菜单
...
```
  ...
  #### <a name="allow-pages-to-send-synchronous-xhr-requests-during-page-dismissal-obsolete"></a>允许页面在页面关闭期间发送同步 XHR 请求(已过时)
...
```
  ...
  #### <a name="allows-the-appcache-feature-to-be-re-enabled-even-if-its-turned-off-by-default-obsolete"></a>允许重新启用 AppCache 功能，即使因默认方式于关闭状态(已过时)
...
```
  ...
  #### <a name="allow-the-audio-process-to-run-with-priority-above-normal-on-windows"></a>允许音频进程在 Windows 上以高于正常的优先级运行
...
如果未配置此策略，则将使用音频进程的默认配置。
此策略旨在作为临时措施，使企业能够以更高的优先级运行音频，以解决音频捕获的某些性能问题。
未来将删除此策略。
...
```
  ...
  #### <a name="enable-autofill-for-payment-instruments"></a>启用付款方式自动填充
...
```
  ...
  #### <a name="allow-media-autoplay-on-specific-sites"></a>在特定站点上允许媒体自动播放
...
如果不配置此策略，则 [AutoplayAllowed](#autoplayallowed) 策略中的全局默认值(如果已设置)或用户的个人配置会应用于所有站点。

关于有效 URL 模式的详细信息，请参阅 [https://go.microsoft.com/fwlink/?linkid=2095322](https://go.microsoft.com/fwlink/?linkid=2095322)。
...
```
  ...
  #### <a name="enables-background-updates-to-the-list-of-available-templates-for-collections-and-other-features-that-use-templates-deprecated"></a>对“集锦”和使用模板的其他功能启用可用模板列表后台更新(已弃用)
  ...
  此策略已弃用，因为我们将迁移到新策略。 版本 104 后，它在 Microsoft Edge 中将不起作用。 要使用的新策略是 [EdgeAssetDeliveryServiceEnabled](#edgeassetdeliveryserviceenabled)。
...
```
  ...
  #### <a name="enable-browser-legacy-extension-point-blocking"></a>启用浏览器旧扩展点阻止
...
如果计划删除对 Mac OS X 上旧版证书验证程序的支持，则它在 Microsoft Edge 版本 107 中不起作用。
...
```
  ...
  #### <a name="cors-non-wildcard-request-header-support-enabled-deprecated"></a>已启用 CORS 非通配符请求标头支持 (已弃用)
...
Microsoft Edge 版本 97 引入了对 CORS 非通配符请求标头的支持。 当脚本通过 fetch() 和 XMLHttpRequest 进行跨源网络请求，并带有脚本添加的授权标头时，该标头必须是由 CORS 预检响应中的 Access-Control-Allow-Headers 标头明确允许的。 此处的‘明确’意味着通配符 "*" 不包含授权标头。 有关更多详细信息，请参阅 [https://go.microsoft.com/fwlink/?linkid=2180022](https://go.microsoft.com/fwlink/?linkid=2180022)。
...
此策略是对新 CORS 非通配符请求标头功能的临时解决方法。 按计划将在 Microsoft Edge 版本 103 后删除。
...
```
  ...
  #### <a name="configure-the-list-of-commands-for-which-to-disable-keyboard-shortcuts"></a>配置要为其禁用键盘快捷方式的命令列表
...
有关要禁用的可能命令的列表，请参阅 [https://go.microsoft.com/fwlink/?linkid=2186950](https://go.microsoft.com/fwlink/?linkid=2186950)。
...
从 Microsoft Edge 89 开始，如果现有本地配置文件已禁用[RoamingProfileSupportEnabled](#roamingprofilesupportenabled)策略，并且计算机现已混合加入，即 其具有 Azure AD 帐户，其将本地配置文件自动升级到 Azure AD 配置文件，以获取完整的 Azure AD 同步设施。

从 Microsoft Edge 93 开始，如果禁用策略 [ImplicitSignInEnabled](#implicitsigninenabled)，则其将不会生效。

从 Microsoft Edge 94 开始，如果启用策略 [OnlyOnPremisesImplicitSigninEnabled](#onlyonpremisesimplicitsigninenabled) 且其设置为 'SignInAndMakeDomainAccountNonRemovable'，则其将生效(即使在混合加入环境中)。 即使具有 MSA 或 AAD 帐户，Microsoft Edge 也将使用其 Active Directory 域帐户自动登录用户。
...
请注意，虽然这是通过 Microsoft Edge 提供的选项，而非使用“在文件资源管理器中查看”选项，但我们建议在管理 SharePoint 外的文件和文件夹时同步 SharePoint 文件或移动或复制 SharePoint 中的文件。
同步 SharePoint 文件: https://go.microsoft.com/fwlink/p/?linkid=2166983 移动或复制 SharePoint 中的文件: https://go.microsoft.com/fwlink/p/?linkid=2167123
...
```
  ...
  #### <a name="specifies-whether-webassembly-modules-can-be-sent-cross-origin-obsolete"></a>指定是否可以跨源发送 WebAssembly 模块（已过时）
...
```
  ...
  #### <a name="specifies-whether-the-display-capture-permissions-policy-is-checked-or-skipped"></a>指定是选中还是跳过显示捕获权限策略
  ...
  根据以下规范，显示捕获权限策略限制对 getDisplayMedia() 的访问权限：https://www.w3.org/TR/screen-capture/#feature-policy-integration。但如果禁用此策略，则不强制执行此要求，并且允许从在其他情况下将禁止的上下文中获取 getDisplayMedia()。 此企业策略是临时的；按计划将在 Microsoft Edge 版本 100 后删除。
它旨在取消阻止应用程序不符合规范但需要时间修复的企业用户。

如果启用或未配置此策略，网站只能从显示捕获权限策略允许的上下文中调用 getDisplayMedia()。

如果禁用此策略，网站甚至可以从显示捕获权限策略不允许的上下文中调用 getDisplayMedia()。
请注意，其他限制可能仍然适用。
...
```
  ...
  ### <a name="donotsilentlyblockprotocolsfromorigins"></a>DoNotSilentlyBlockProtocolsFromOrigins

  #### <a name="define-a-list-of-protocols-that-can-not-be-silently-blocked-by-anti-flood-protection"></a>定义防淹没防护无法静默阻止的协议列表
...
将“BlockDangerousDownloads”设置为允许所有下载，但不包括带有 Microsoft Defender SmartScreen 已知或潜在危险下载警告或具有危险文件类型扩展名的下载。
...
```
  ...
  ### <a name="edgeassetdeliveryserviceenabled"></a>EdgeAssetDeliveryServiceEnabled

  #### <a name="allow-features-to-download-assets-from-the-asset-delivery-service"></a>允许功能从资产传递服务下载资产
  ...
  资产传送服务是用于将资产传送到 Microsoft Edge 客户端的常规管道。
这些资产可以是配置文件或机器学习模型，为使用此服务的功能提供支持。
...
```
  ...
  #### <a name="discover-feature-in-microsoft-edge"></a>发现 Microsoft Edge 中的功能
...
```
  ...
  #### <a name="enable-follow-service-in-microsoft-edge"></a>在 Microsoft Edge 中启用关注服务
...
```
  ...
  #### <a name="enhance-the-security-state-in-microsoft-edge"></a>增强 Microsoft Edge 中的安全状态
...
```
  ...
  #### <a name="configure-the-list-of-domains-for-which-enhance-security-mode-will-not-be-enforced"></a>配置将不会强制执行增强安全模式的域列表
...
```
  ...
  #### <a name="configure-the-list-of-domains-for-which-enhance-security-mode-will-always-be-enforced"></a>配置将始终强制执行增强安全模式的域列表
...
```
  ...
  #### <a name="configure-whether-microsoft-edge-should-automatically-select-a-certificate-when-there-are-multiple-certificate-matches-for-a-site-configured-with-autoselectcertificateforurls-deprecated"></a>当使用“AutoSelectCertificateForUrls”配置的网站具有多个证书匹配项时，配置 Microsoft Edge 是否应自动选择证书（已弃用）
  ...
  此策略已弃用，因为我们将迁移到新策略。 它在 Microsoft Edge 版本 104 中不起作用。 要使用的新策略为 [PromptOnMultipleMatchingCertificates](#promptonmultiplematchingcertificates)。
...
```
  ...
  ### <a name="forcemajorversiontominorpositioninuseragent"></a>ForceMajorVersionToMinorPositionInUserAgent

  #### <a name="enable-or-disable-freezing-the-user-agent-string-at-major-version-99"></a>启用或禁用将用户代理字符串冻结在主版本 99
...
用户代理请求标头允许网站标识请求用户代理的应用程序、操作系统、供应商和/或版本。
某些网站假设如何设置此标头的格式，并且可能会遇到版本字符串的问题，这些版本字符串在主要位置包含三个数字（例如 100.0.0.0）。

将策略设置为"默认"或将其取消设置将默认为用户代理字符串主版本的浏览器设置。
如果设置为"ForceEnabled"，则用户代理字符串将始终将主版本报告为 99，并将浏览器的主要版本包含在次要位置。 例如，浏览器版本 101.0.0.0 将发送报告版本 99.101.0.0 的用户代理请求标头。
如果设置为"ForceDisabled"，则用户代理字符串不会冻结主版本。
...
```
  ...
  ### <a name="hiderestoredialogenabled"></a>HideRestoreDialogEnabled

  #### <a name="hide-restore-pages-dialog-after-browser-crash"></a>在浏览器崩溃后隐藏“还原页面”对话框
...
如果启用此策略，则不会显示"还原页面"对话框。

如果禁用或未设置此策略，将显示"还原页面"对话框。

如果设置此策略，请不要设置 [ClearBrowsingDataOnExit](#clearbrowsingdataonexit) 或 [SavingBrowserHistoryDisabled](#savingbrowserhistorydisabled) 策略，因为这会阻止保存历史记录，也会禁用对话框。
...
```
  ...
  ### <a name="hubssidebarenabled"></a>HubsSidebarEnabled

  #### <a name="show-hubs-sidebar"></a>显示中心边栏
  ...
  显示 Microsoft Edge 屏幕右侧的启动器栏。

启用此策略以始终显示边栏。
禁用此策略以从不显示边栏。

如果未配置策略，用户可以选择是否显示边栏。
...
```
  ...
  #### <a name="in-app-support-enabled"></a>已启用应用内支持
...
```
  ...
  ### <a name="internetexplorerintegrationcloudneutralsitesreporting"></a>InternetExplorerIntegrationCloudNeutralSitesReporting

  #### <a name="configure-reporting-of-potentially-misconfigured-neutral-site-urls-to-the-m365-admin-center-site-lists-app"></a>配置向 M365 管理中心网站列表应用报告可能配置错误的中性网站 URL
...
启用此策略时，必须指定 O365 租户 ID。 若要详细了解如何查找 O365 租户 ID，请参阅 [https://go.microsoft.com/fwlink/?linkid=2185668](https://go.microsoft.com/fwlink/?linkid=2185668)

如果禁用或未配置此策略，Microsoft Edge 绝不会向网站列表应用发送有关可能配置错误的非特定网站的报告。

若要了解有关 Internet Explorer 模式的详细信息，请参阅 [https://go.microsoft.com/fwlink/?linkid=2165707](https://go.microsoft.com/fwlink/?linkid=2165707)
...
```
  ...
  #### <a name="configure-the-enterprise-mode-cloud-site-list"></a>配置“企业模式云站点列表”
...
只有当配置了 [InternetExplorerIntegrationLevel](#internetexplorerintegrationlevel) 设置时，此设置才适用。

如果配置此策略，则 Microsoft Edge 将使用指定的站点列表。 启用后，可以输入在 M365 管理中心内创建并发布到云的站点列表的标识符。

此设置优先于 Microsoft Edge 的 [InternetExplorerIntegrationSiteList](#internetexplorerintegrationsitelist) 策略以及Internet Explorer 的站点列表设置(使用企业模式 IE 网站列表)。 如果禁用或不配置此策略，则 Microsoft Edge 将改用 [InternetExplorerIntegrationSiteList](#internetexplorerintegrationsitelist) 策略。

要了解有关 Internet Explorer 模式的详细信息，请参阅 [https://go.microsoft.com/fwlink/?linkid=2165707](https://go.microsoft.com/fwlink/?linkid=2165707)
...
```
  ...
  ### <a name="internetexplorerintegrationcloudusersitesreporting"></a>InternetExplorerIntegrationCloudUserSitesReporting

  #### <a name="configure-reporting-of-ie-mode-user-list-entries-to-the-m365-admin-center-site-lists-app"></a>配置向 M365 管理中心网站列表应用报告 IE 模式用户列表条目
...
```
  ...
  #### <a name="configure-how-frequently-the-enterprise-mode-site-list-is-refreshed"></a>配置刷新“企业模式站点列表”的频率
...
只有当配置了 [ InternetExplorerIntegrationSiteList](#internetexplorerintegrationsitelist) 或 [InternetExplorerIntegrationCloudSiteList](#internetexplorerintegrationcloudsitelist) 设置时，此设置才适用。
...
```
  ...
  #### <a name="allow-internet-explorer-mode-testing-obsolete"></a>允许 Internet Explorer 模式测试（已过时）
  ...
  此策略已过时，因为它已由改进的功能取代。 它在版本 94 之后的 Microsoft Edge 中不起作用。 要允许用户在 Internet Explorer 模式下打开应用程序，请改用 [InternetExplorerIntegrationReloadInIEModeAllowed](#internetexplorerintegrationreloadiniemodeallowed) 策略。 或者，用户仍然可以使用 --ie-mode-test 标记。
...
```
  ...
  #### <a name="configure-the-pixel-adjustment-between-windowopen-heights-sourced-from-ie-mode-pages-vs-edge-mode-pages"></a>配置源自 IE 模式页面和 Edge 模式页面的 window.open 高度之间的像素调整
...
```
  ...
  #### <a name="configure-the-pixel-adjustment-between-windowopen-widths-sourced-from-ie-mode-pages-vs-edge-mode-pages"></a>配置源自 IE 模式页面和 Edge 模式页面的 window.open 宽度之间的像素调整
...
```
  ...
  #### <a name="allow-save-page-as-in-internet-explorer-mode"></a>允许在 Internet Explorer 模式下使用“页面另存为”
...
用户可以使用此选项在浏览器中保存当前页面。 当用户重新打开已保存的页面时，它将加载到默认浏览器中。
...
```
  ...
  #### <a name="allow-sites-configured-for-internet-explorer-mode-to-open-in-microsoft-edge"></a>允许为 Internet Explorer 模式配置的网站在 Microsoft Edge 中打开
...
```
  ...
  #### <a name="always-use-microsoft-autoupdate-as-the-updater-for-microsoft-edge"></a>始终将 Microsoft AutoUpdate 用作 Microsoft Edge 的更新程序
...
```
  ...
  #### <a name="microsoft-edge-insider-promotion-enabled"></a>已启用 Microsoft Edge 预览体验成员促销
...
```
  ...
  #### <a name="allow-users-to-access-the-microsoft-office-menu"></a>允许用户访问 Microsoft Office 菜单
...
如果禁用此策略，用户将无法访问 Microsoft Office 菜单。
  ...
  - GP 名称：允许用户访问 Microsoft Office 菜单
  - GP 路径（强制）：管理模板/Microsoft Edge/
  - GP 路径（推荐）：不适用
  - GP ADMX 文件名：MSEdge.admx
...
```
  ...
  ### <a name="pdfsecuremode"></a>PDFSecureMode

  #### <a name="secure-mode-and-certificate-based-digital-signature-validation-in-native-pdf-reader"></a>本机 PDF 阅读器中的安全模式和基于证书的数字签名验证
...
```
  ...
  #### <a name="prompt-the-user-to-select-a-certificate-when-multiple-certificates-match"></a>当多个证书匹配时提示用户选择证书
  ...
  此策略控制当多个证书与 [AutoSelectCertificateForUrls](#autoselectcertificateforurls) 匹配时是否提示用户选择客户端证书。
如果此策略设置为 True，则每当自动选择策略与多个证书匹配时，系统都会提示用户选择客户端证书。
...
```
  ...
  ### <a name="relatedmatchescloudserviceenabled"></a>RelatedMatchesCloudServiceEnabled

  #### <a name="configure-related-matches-in-find-on-page"></a>在“在页面查找”中配置相关匹配项
...
```
  ...
  #### <a name="set-the-time-interval-for-relaunch"></a>设置重启的时间间隔
...
```
  ...
  #### <a name="allow-remote-debugging"></a>允许远程调试
...
```
  ...
  #### <a name="restrict-which-accounts-can-be-used-to-sign-in-to-microsoft-edge"></a>限制哪些账户可以用来登录 Microsoft Edge
...
```
  ...
  #### <a name="allow-microsoft-edge-to-block-navigations-to-external-protocols-in-a-sandboxed-iframe"></a>允许 Microsoft Edge 在沙盒 iframe 中阻止对外部协议的导航
...
如果禁用此策略，对屏幕共享 API 的调用将失败。 例如，如果你使用的是基于 Web 的联机会议，则视频或屏幕共享将不起作用。  但是，如果网站与以下任一策略中的源模式匹配，则不考虑此策略 (将允许网站使用屏幕共享 API)[ScreenCaptureAllowedByOrigins](#screencaptureallowedbyorigins)、[WindowCaptureAllowedByOrigins](#windowcaptureallowedbyorigins)、[TabCaptureAllowedByOrigins](#tabcaptureallowedbyorigins)、[SameOriginTabCaptureAllowedByOrigins](#sameorigintabcaptureallowedbyorigins)。
...
```
  ...
  #### <a name="allow-users-to-configure-site-safety-services"></a>允许用户配置网站安全服务
...
```
  ...
  #### <a name="enable-travel-assistance"></a>启用旅行协助
...
旅行协助功能为在浏览器中执行“旅行”相关任务的用户提供有用的相关信息。 此功能为 Microsoft 收集的来自不同源的用户提供可信且经过验证的建议 / 信息。

如果启用或不配置此设置，则在用户执行旅行相关任务时，将为其启用该功能。

如果禁用此设置，则将禁用旅行协助，且用户将无法查看任何旅行相关建议。
...
```
  ...
  #### <a name="allow-using-the-deprecated-u2f-security-key-api-deprecated"></a>允许使用已废弃的 U2F 安全密钥 API (已弃用)
  ...
  此策略已弃用，因为它作为一种短期机制提供，目的是让企业当发现它与删除 U2F 安全密钥 API 的变化不兼容时，有更多的时间来更新他们的网页内容。 它在 Microsoft Edge 版本 104 中不起作用。

如果启用此策略，则可以使用已弃用的 U2F 安全密钥 API，并禁止显示 U2F API 请求的弃用提醒提示。

如果禁用或未配置此策略，则 U2F 安全密钥 API 默认处于禁用状态，并且只能由注册和使用 U2FSecurityKeyAPI 源试用版 (在 Microsoft Edge 版本 104 中结束) 的站点使用。
  ...
  - GP 名称: 允许使用已弃用的 U2F 安全密钥 API (已弃用)
  - GP 路径（强制）：管理模板/Microsoft Edge/
  - GP 路径（推荐）：不适用
  - GP ADMX 文件名：MSEdge.admx
...
```
  ...
  #### <a name="enable-the-user-agent-client-hints-feature-obsolete"></a>启用“User-Agent 客户端提示”功能(已过时)
...
```
  ...
  ### <a name="useragentreduction"></a>UserAgentReduction

  #### <a name="enable-or-disable-the-user-agent-reduction"></a>启用或禁用用户代理缩减
...
将此策略设置为 "ForceEnabled" 以强制缩减用户代理请求标头的版本。

将此策略设置为 "ForceDisabled" 以强制使用用户代理请求标头的完整版本。
...
```
  ...
  #### <a name="visual-search-enabled"></a>已启用视觉搜索
...
- custom_name (允许永久覆盖所有 Web 应用和 PWA 的应用名称。 当前不支持 Microsoft Edge。)

- custom_icon (允许覆盖已安装应用的应用图标。 图标必须为正方形，大小最大为 1 MB，并采用以下格式之一：jpeg、png、gif、webp、ico。 哈希值必须是图标文件的 SHA256 哈希。 当前不支持 Microsoft Edge。)
...
```
  ...
  #### <a name="enable-support-for-windows-os-routing-table-rules-when-making-peer-to-peer-connections-via-webrtc"></a>通过 WebRTC 建立对等连接时启用对 Windows 操作系统路由表规则的支持
...
```
  ...
  #### <a name="force-websql-in-third-party-contexts-to-be-re-enabled-obsolete"></a>强制重新启用第三方上下文中的 WebSQL（已过时）
...
```
  ...
  #### <a name="use-windows-proxy-resolver"></a>使用 Windows 代理解析程序
